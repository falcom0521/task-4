...
import { RemoveCompletedTask, ToggleTaskCompletion } from "../../redux/actions";
import { Image } from "react-native-elements";

const { width } = Dimensions.get("window");

const CompletedTaskList = ({ compleateList, sortingDate }) => {
      ...
      Alert.alert(
        ...
        [
          ...
          },
          {
            text: "OK",
            onPress: () => {
              dispatch(RemoveCompletedTask(idPass));
  ...
  const renderEmptyComponent = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.EmptysubText}>No listed completed tasks</Text>
    </View>
  );
